...
Mikrokontroler: GOOUUU ESP32-S3-CAM V1.3 (vyžaduje podporu PSRAM)
Kamera: OV2640 (klíčová komponenta pro AI analýzu)
Teplotní senzor: DS18B20 / MY18E20 (1-Wire sběrnice)
...
Peltier PWM
GPIO21
PWM regulace výkonu chlazení
Vnitřní ventilátor
GPIO38
PWM regulace otáček (vnitřní)
Vnější ventilátor
GPIO40
PWM regulace otáček (vnější)
Tacho vnitřní
GPIO39
Monitorování otáček vnitřního ventilátoru
Tacho vnější
GPIO41
Monitorování otáček vnějšího ventilátoru
RGB LED
GPIO48
Datový výstup pro WS2812
Tlačítko
GPIO47
Vstup pro aktivaci AI analýzy
